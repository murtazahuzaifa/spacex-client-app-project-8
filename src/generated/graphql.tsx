...
export type LauncheMissionInfoQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const MissionsInfoDocument = gql`
  ...
  launches {
    ...
    `;
export type MissionsInfoComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<MissionsInfoQuery, MissionsInfoQueryVariables>, 'query'>;

    export const MissionsInfoComponent = (props: MissionsInfoComponentProps) => (
      <ApolloReactComponents.Query<MissionsInfoQuery, MissionsInfoQueryVariables> query={MissionsInfoDocument} {...props} />
    );
    
export type MissionsInfoProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<MissionsInfoQuery, MissionsInfoQueryVariables>
    } & TChildProps;
export function withMissionsInfo<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  MissionsInfoQuery,
  MissionsInfoQueryVariables,
  MissionsInfoProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, MissionsInfoQuery, MissionsInfoQueryVariables, MissionsInfoProps<TChildProps, TDataName>>(MissionsInfoDocument, {
      alias: 'missionsInfo',
      ...operationOptions
    });
};
 ...
 * });
 */
export function useMissionsInfoQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<MissionsInfoQuery, MissionsInfoQueryVariables>) {
        return ApolloReactHooks.useQuery<MissionsInfoQuery, MissionsInfoQueryVariables>(MissionsInfoDocument, baseOptions);
      }
export function useMissionsInfoLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<MissionsInfoQuery, MissionsInfoQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<MissionsInfoQuery, MissionsInfoQueryVariables>(MissionsInfoDocument, baseOptions);
        }
...
export type MissionsInfoQueryResult = ApolloReactCommon.QueryResult<MissionsInfoQuery, MissionsInfoQueryVariables>;
export const LauncheMissionInfoDocument = gql`
  ...
  launch(id: $id) {
    ...
    `;
export type LauncheMissionInfoComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>, 'query'> & ({ variables: LauncheMissionInfoQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const LauncheMissionInfoComponent = (props: LauncheMissionInfoComponentProps) => (
      <ApolloReactComponents.Query<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables> query={LauncheMissionInfoDocument} {...props} />
    );
    
export type LauncheMissionInfoProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>
    } & TChildProps;
export function withLauncheMissionInfo<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  LauncheMissionInfoQuery,
  LauncheMissionInfoQueryVariables,
  LauncheMissionInfoProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables, LauncheMissionInfoProps<TChildProps, TDataName>>(LauncheMissionInfoDocument, {
      alias: 'launcheMissionInfo',
      ...operationOptions
    });
};
 ...
 * });
 */
export function useLauncheMissionInfoQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>) {
        return ApolloReactHooks.useQuery<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>(LauncheMissionInfoDocument, baseOptions);
      }
export function useLauncheMissionInfoLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>(LauncheMissionInfoDocument, baseOptions);
        }
...
export type LauncheMissionInfoQueryResult = ApolloReactCommon.QueryResult<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>;